...
struct qt_meta_stringdata_Begin_t {
    QByteArrayData data[3];
    char stringdata0[25];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Begin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Begin_t qt_meta_stringdata_Begin = {
    {
QT_MOC_LITERAL(0, 0, 5), // "Begin"
QT_MOC_LITERAL(1, 6, 17), // "on_button_clicked"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "Begin\0on_button_clicked\0"
};
...
QT_INIT_METAOBJECT const QMetaObject Begin::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_meta_stringdata_Begin.data,
    qt_meta_data_Begin,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Begin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Begin.stringdata0))
