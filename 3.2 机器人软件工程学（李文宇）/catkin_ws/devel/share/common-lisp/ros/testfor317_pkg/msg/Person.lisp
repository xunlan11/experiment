...
(cl:in-package testfor317_pkg-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Person>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Person)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name testfor317_pkg-msg:<Person> is deprecated: use testfor317_pkg-msg:Person instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testfor317_pkg-msg:name-val is deprecated.  Use testfor317_pkg-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'sex-val :lambda-list '(m))
(cl:defmethod sex-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testfor317_pkg-msg:sex-val is deprecated.  Use testfor317_pkg-msg:sex instead.")
  (sex m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <Person>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader testfor317_pkg-msg:age-val is deprecated.  Use testfor317_pkg-msg:age instead.")
  (age m))
